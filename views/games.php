<?php
    require_once '../control/games-control.php';
?>
<!DOCTYPE html>
<html lang="en">
	<head>
		...
		<title>Game Review | Review</title>
		...
		<div class="container col-md-offset-2">
			...
			<div class="card" style="margin:1%; width:21rem; display:inline-block;">
				<img class="rounded img-fluid" src="../images/popcorn.jpg">
  				<div class="card-body">
    				<h3 class="card-title text-dark"><?php echo $row['g_name']; ?></h3>
    				<p class="card-text text-left text-dark">
						<?php echo substr($row['g_description'], 0, 60) . "...";?>
					</p>
